                        ...
                        <div class="col-md-12">
                            <form action="{{ url('admin/question/update/'.$campaign_id.'/'.$question->id) }}" role="form" class="question-form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select  class="form-control" name="question_input_type_id">
                                            ...
                                            <td width="10%">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        class="masking-enable" value="{{ isset($question->masking_enable)? $question->masking_enable : 1 }}" name="masking_enable">
                                                        Masking enable ?
                                                    </label>
                                                </div>
                                            </td>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td width="10%">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" <?php if ($question->branching_enable == 1) { echo 'checked="checked"'; } ?> class="branching"
