        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    @endif
                    <form type="post" id="sign-up" action="{{ url('register/post') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <a href="{{ url('/sign-in') }}">Already have an account</a>
                            </div>
                            <div class="col-md-8">
                                <input type="submit" class="btn btn-main-color btn-squared pull-right" value="Sign Up">
                            </div>
                        </div>
                    </form>
                </div>
