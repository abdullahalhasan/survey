            ...
            <div class="tabbable">
                ...
                <div class="tab-content">
                    ...
                    <div id="panel_overview" class="tab-pane in {{isset($tab) && ($tab=='panel_overview') ? 'active' : ''}}">
                        <div class="row">
                                ...
                                <div class="user-left">
                                    <div class="center">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <form action="{{url('normal/user/profile/image/update')}}" method="post" enctype="multipart/form-data">
                                                <input type="hidden" name="_token" value="{{csrf_token()}}" >
                                                <div class="user-image">
                                                    <div class="fileupload-new thumbnail profile_img_size">
                                                        @if(!empty($user_info->user_profile_image))
                                                            <img src="{{asset('public/assets/images/user/normal/'.$user_info->user_profile_image)}}" alt="User Profile Photo">
                                                        @else
                                                            <img src="{{asset('public/assets/images/user/normal/profile.png')}}" alt="User Profile Photo">
                                                        @endif
                                                    </div>
                            ...
                            <div class="col-sm-7 col-md-8">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <a href="{{url('normal/user/profile?tab=messages')}}" style="text-decoration:none">
                                    ...
                                    <div class="col-sm-3">
                                        <a href="{{url('normal/user/profile?tab=notifications')}}" style="text-decoration:none">
                                    ...
                                    <div class="col-sm-3">
                                        <a href="{{url('normal/user/profile?tab=change_password')}}" style="text-decoration:none">
                                            <button class="btn btn-icon btn-block">
                    ...
                    <div id="panel_edit_account" class="tab-pane in {{isset($tab) && ($tab=='panel_edit_account') ? 'active' : ''}}">
                        <form action="{{url('normal/user/profile/update')}}" method="post" enctype="multipart/form-data" role="form" id="form">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3>Account Info</h3>
                                    <hr>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3 change_password">
                                ...
                                <div class="col-md-8 info"><h1><i class="fa fa-lock"></i> {{isset($user_info->name) ? $user_info->name : ''}}</h1>
                                    <form action="{{url('normal/user/change/password')}}" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="_token" value="{{csrf_token()}}" >
                                        <div class="row">
