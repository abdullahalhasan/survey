        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default btn-squared">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ url('admin/survey/campaign/store') }}" method="post" role="form" id="survey-campaign-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="campaign_title" placeholder="Please insert campaign title" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">
                                        <strong>Campaign owner <span class="symbol required"></span></strong>
                                    </label>
                                    <input type="text" name="campaign_owner" placeholder="Please insert campaign owner" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">
                                    ...
                                    <div class="input-group">
                                        <input type="text" data-date-format="yyyy-mm-dd" data-date-viewmode="years"
                                               class="form-control date-picker" name="active_date">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" data-date-format="yyyy-mm-dd" data-date-viewmode="years"
                                                       class="form-control date-picker" name="expire_date">
                                                <span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="campaign_incentive_amount" placeholder="Please insert incentive amount" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">
                                        <strong>Campaign incentive point <span class="symbol required"></span></strong>
                                    </label>
                                    <input type="text" name="campaign_incentive_point" placeholder="Please insert incentive point" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">
                                        <strong>Campaign instructions <span class="symbol required"></span></strong>
                                    </label>
                                    <input type="text" name="campaign_instructions" placeholder="Please insert campaign instructions" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">
                                        <strong>Campaign ending text <span class="symbol required"></span></strong>
                                    </label>
                                    <input type="text" name="campaign_ending_text" placeholder="Please insert campaign ending text" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
