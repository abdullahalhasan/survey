        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default btn-squared">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ url('admin/company/update/'.$company->id) }}" method="post" role="form" id="company-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="web_url" value="{{ $company->web_url }}" class="form-control">
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" cols="10" rows="5">{{ $company->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
